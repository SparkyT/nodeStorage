...
function xmlBuildMenusFromOpmltext (opmltext, idMenuToInsertAfter, evalCallback, newMenuCommandCallback) { //1/17/17 by DW
	...
	xmlOneLevelVisit (adrbody, function (adrmenu) {
		if (!xmlIsComment (adrmenu)) {
			...
			var idThisMenu = "idScriptMenu" + ++ctScriptMenus;
